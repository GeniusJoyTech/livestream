...
class ScreenCaptureTrack(VideoStreamTrack):
    ...
    def update_monitor(self):
        total_monitores = len(self.sct.monitors) - 1
        if self.monitor_number <= 0 or self.monitor_number > total_monitores:
...
class Broadcaster:
    ...
    async def _handle_new_viewer(self, socket, data):
        ...
        print(f"🎥 Captura iniciada — {len(self.peers)} viewer(s) conectados.")
...
if __name__ == "__main__":
    ...
    broadcaster = Broadcaster(signaling_url, broadcaster_name="Minha tela")
